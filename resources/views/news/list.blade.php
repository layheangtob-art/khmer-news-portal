                                    ...
                                    <div class="col-md-8">
                                        <div class="news-item-content p-4">
                                            ...
                                            <div class="news-item-stats">
                                                ...
                                                @endphp
                                                <div class="d-flex">
                                                    <form action="{{ route('news.like', $news->id) }}" method="POST" class="d-inline m-0 p-0" id="all-list-like-form-{{ $news->id }}">
                                                        @csrf
                                                        <button type="button" class="btn btn-link p-0 text-decoration-none like-btn d-flex align-items-center" data-form-id="all-list-like-form-{{ $news->id }}" style="color: inherit;">
